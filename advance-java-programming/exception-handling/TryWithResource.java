    ...
    public static void main(String[] args) {
        ...
        try (FileReader fr = new FileReader(
            ...
            while ((line = br.readLine()) != null) {
                // System.out.println(br.readLine());//now it print next line instead of first
                // line
        ...
        // try(FileWriter fw = new FileWriter("bridgelabz-training-java-programming\\\\advance-java-programming\\\\exception-handling\\\\file.txt") , BufferedWriter bw = new BufferedWriter(fw)) {
