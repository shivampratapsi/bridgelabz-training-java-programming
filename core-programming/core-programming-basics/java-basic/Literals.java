...
public class Literals {
    public static void main(String[] args) {
        ...
        // cant use underscore at the end of the literal and after the suffix L or l and
        // start of the literal
        long creditCardNumber = 1234_5678_9012_3456L;

        // float pi = 3._1415f ; // this gives error because we cant use underscore
        // after & before the decimal point
        float pi = 3.14_15f;
        // long hexBytes = 0x_FF_EC_DE_5E ; this gives error because we cant use
        // underscore after & before & between 0x
